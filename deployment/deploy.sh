...
# Display IP address and pause for DNS configuration
echo "=============================================="
echo "Elastic IP Address: ${EC2_PUBLIC_IP}"
echo "=============================================="
echo "Please configure your DNS settings to point to this IP address."
echo "Your domain (${DOMAIN_NAME}) should point to ${EC2_PUBLIC_IP}"
echo ""

# Ask user if DNS configuration is complete
while true; do
    read -p "Have you completed the DNS configuration? (yes/no): " DNS_CONFIGURED
    case $DNS_CONFIGURED in
        [Yy]* ) 
            echo "Continuing with deployment..."
            break;;
        [Nn]* ) 
            echo "Please complete the DNS configuration before continuing."
            echo "Elastic IP Address: ${EC2_PUBLIC_IP}";;
        * ) 
...
echo "Your domain is available at: ${DOMAIN_NAME}"
echo "Your domain is available at: ${DOMAIN_NAME}"
echo "Your domain is available at: ${DOMAIN_NAME}"
echo "Your domain is available at: ${DOMAIN_NAME}"
echo "Your domain is available at: ${DOMAIN_NAME}"
...
echo "Your domain is available at: ${DOMAIN_NAME}"
echo "Your domain is available at: ${DOMAIN_NAME}"
echo "Your domain is available at: ${DOMAIN